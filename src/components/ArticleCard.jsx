...
function App({ imgSrc, title, newsSource, desc, width, height }) {
  return (
    <Box className="article-card" sx={{ width, height,display:'flex' ,flexDirection:'column',fontFamily: '\'PT Sans\', sans-serif'}}>
      ...
      <Box className="card-buttons" sx={{ width: '100%', display: 'flex' }}>
        ...
        <Box className="seperator" sx={{height:'100%',width:'2px', backgroundColor:'#E6F5FB'}}></Box>
